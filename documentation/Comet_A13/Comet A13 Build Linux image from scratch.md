# Comet A13: Build Linux image from scratch
...
git clone -b comet-a13-revA_v1.0 https://github.com/terasic/arm-trusted-firmware arm-trusted-firmware
...
git clone -b comet-a13-revA_v1.0 https://github.com/terasic/u-boot-socfpga u-boot-socfpga
cd u-boot-socfpga
make mrproper
make socfpga_agilex5_comet_a13_defconfig
# link to ATF
...
>         fatload mmc 0:1 ${fdt_addr_r} socfpga_agilex5_comet_a13.dtb;
...
cd $TOP_FOLDER
rm -rf linux-socfpga
git clone -b comet-a13-revA_v1.0 https://github.com/terasic/linux-socfpga linux-socfpga
cd linux-socfpga
cp comet-a13.config .config
...
*   \$TOPFOLDER/linux-socfpga/arch/arm64/boot/dts/intel/socfpga\_agilex5\_comet\_a13.dtb
...
cp $TOP_FOLDER/linux-socfpga/arch/arm64/boot/dts/intel/socfpga_agilex5_comet_a13.dtb .
...
cp $TOP_FOLDER/u-boot-socfpga/u-boot.itb .
cp $TOP_FOLDER/linux-socfpga/arch/arm64/boot/Image .
cp $TOP_FOLDER/linux-socfpga/arch/arm64/boot/dts/intel/socfpga_agilex5_comet_a13_emmc.dtb ./socfpga_agilex5_comet_a13.dtb
cp $TOP_FOLDER/uboot-script/boot.scr.uimg .
cd ..
...
1.  Make sure Quartus Pro 25.3 is installed
2.  Go to GHRD project directory (copy from Comet A13 System CD)
