# Comet A65: Build Linux image from scratch
...
git clone -b comet-a65-revB_v1.0 https://github.com/terasic/arm-trusted-firmware arm-trusted-firmware
...
git clone -b comet-a65-revB_v1.1 https://github.com/terasic/u-boot-socfpga u-boot-socfpga
cd u-boot-socfpga
make mrproper
make socfpga_agilex5_comet_a65_defconfig
# link to ATF
...
>         fatload mmc 0:1 ${fdt_addr_r} socfpga_agilex5_comet_a65.dtb;
...
cd $TOP_FOLDER
rm -rf linux-socfpga
git clone -b comet-a65-revB_v1.0 https://github.com/terasic/linux-socfpga linux-socfpga
cd linux-socfpga
cp comet_a65_revB.config .config
...
*   \$TOPFOLDER/linux-socfpga/arch/arm64/boot/dts/intel/socfpga\_agilex5\_comet\_a65.dtb
...
cp $TOP_FOLDER/linux-socfpga/arch/arm64/boot/dts/intel/socfpga_agilex5_comet_a65.dtb .
...
2.  Go to GHRD project directory (copy from Comet A65 System CD)
